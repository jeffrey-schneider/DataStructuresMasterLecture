...
public class HashFunction2 {
	...
	public static void main(String[] args) {
		HashFunction2 hashFunction = new HashFunction2(31);
		...
		hashFunction.hashFunction2(elementsToAdd2, hashFunction.theArray);
                System.out.println("Output the matches that would put an item in index 0 if arraySize was 31");
		hashFunction.modThirty();
		hashFunction.increaseArraySize(60);
		hashFunction.displayTheHash();
                
                //Comment these two methods out to show clustering
		//hashFunction.fillArrayWithNeg1();
		//hashFunction.doubleHashFunc(elementsToAdd2, hashFunction.theArray);
		//hashFunction.displayTheHash();
		//hashFunction.findKeyDblHashed("990");
	...
	public void doubleHashFunc(String[] stringsForArray, String[] theArray) {
		for (int n = 0; n < stringsForArray.length; n++) {
			...
			// avoid creating clusters
                        // Make stepDistance a prime number < 10
